function makeScreenshot() {
  html2canvas(document.getElementById("screenshot"), { scale: 2 }).then(
    (canvas) => {
      canvas.id = "canvasID";
...
$(document).ready(function () {
    document.getElementById("a-make").addEventListener(
        "click",
        function () {
      ...
      document.getElementById("a-download").addEventListener(
        "click",
        function () {
    ...
    request.onload = function () {
      if (request.status >= 200 && request.status < 400) {
        var foud_night = JSON.parse(this.response);
        ...
        if (found_night.board_game.name != undefined) {
          ...
          document.getElementById("bg_name").innerHTML =
            found_night.board_game.name;
        ...
        if (found_night.beer.name != undefined) {
          ...
          if (
            found_night.beer.image == "Sorry, no picture provided for this beer"
          ) {
        ...
        if (found_night.movie.year != undefined) {
          ...
          document.getElementById("movie_title").innerHTML =
            found_night.movie.title;
          document.getElementById("movie_date").innerHTML =
            found_night.movie.year;
          document.getElementById("movie_plot").innerHTML =
            found_night.movie.plot;
          if (
          ...
          if (
            found_night.movie.cast != null &&
            found_night.movie.cast.length > 0
          ) {
          ...
          if (
            ...
            for (t = 0; t < len; t++) {
              if (t == len - 1) {
                ...
                document.getElementById("tv_cast").innerHTML +=
                  my_cast[t] + " <br> ";
              }
            }
          } else {
            document.getElementById("tv_cast").innerHTML =
              "Sorry no cast available";
          }
          if (
            found_night.movie.languages != null &&
            found_night.movie.languages.length > 0
