...
<<<<<<< HEAD
              ...
              if (risposta[i].artist.id != undefined){
                elementi +=1;
                alert("Artista: " + JSON.stringify(risposta[i].artist ));
                ...
                if(risposta[i].artist.tracks != undefined){
                  //alert("E' un album!")
                  //alert("Nome: " + risposta[i].artist.name);
                  var string = "Album: " + risposta[i].artist.name + " by: ";
                  var my_artists = risposta[i].artist.artists;
                  if(my_artists.length ==1) string+=  risposta[i].artist.artists[0];
                  else{
                    var t=0;
                    var len = my_artists.length;
                    for(t=0; t<len; t++){
                      if(t==len-1){
                        string += risposta[i].artist.artists[t];
                      }
                      else{
                        string += risposta[i].artist.artists[t] + "& " ;
                      }
                  ...
                  //alert("E' una canzone!");
                   var string = "Song: " + risposta[i].artist.name + " by: " ;
                   //alert("String:" + risposta[i].artist.artists.length);
                   //alert("Nome: " + risposta[i].artist.name);
                   var my_artists = risposta[i].artist.artists;
                   //alert("Aristi: " +  risposta[i].artist.artists);
                   if(my_artists.length == 1) string+=  risposta[i].artist.artists[0];
                   else{
                     var t=0;
                     var len = my_artists.length;
                ...
                my_artist_img.src = risposta[i].artist.album_image
